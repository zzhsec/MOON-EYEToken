...
contract Mooneye is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MOONEYE";
    string private _symbol = "ME";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6049426d29a7E9a10fAfa2f90f39F7A05Ec570f9);
    address payable public teamWalletAddress = payable(0xA0db16B69aB1D269B46d420b5fEA860eb552F6F0);
